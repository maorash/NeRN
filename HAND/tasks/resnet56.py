...
from HAND.tasks.cifar_resnet import ResNet, ResNetX2, BasicBlockA, BasicBlockB


class ResNet56X2(ResNetX2):
    def __init__(self, basic_block_option='A', **kwargs):
        ...
        super(ResNet56X2, self).__init__(basic_block, [9, 9, 9], **kwargs)
...
class ReconstructedResNet56X2(ReconstructedModel):
    def __init__(self, original_model: ResNet56, train_cfg: TrainConfig, device: str, sampling_mode: str = None):
        super(ReconstructedResNet56X2, self).__init__(original_model, train_cfg, device, sampling_mode)
