...
parser.add_argument('--arch', '-a', metavar='ARCH', default='resnet56x2',
                    choices=model_names,
...
# parser.add_argument('--resume', default='/nfs/private/zohar/HandCompress/HAND/reconstructed_x2_weights.pth', type=str, metavar='PATH',
...
parser.add_argument('--smoothness-type', type=str, default="Cosine",
                    help='Smoothness regularization, can be Cosine/L2')
parser.add_argument('--cosine-smoothness-factor', type=float, default=0.0,
...
def main():
    ...
    for layer_params in model.module.get_learnable_weights():
